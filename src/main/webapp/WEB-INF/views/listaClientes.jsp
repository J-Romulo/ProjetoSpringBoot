...
<link rel="stylesheet" href="../resources/css/listaClientes.css">
			...
			<table border="2" width="70%" cellpadding="2">
				...
				<c:forEach var="cliente" items="${clientes}">
					<tr>
						...
						<th>${cliente.cpf}</th>
						<th>${cliente.email}</th>
						<th>${cliente.nascimento}</th>
						<th>${cliente.telefone}</th>
						<th><a href="/clientes/excluir/${cliente.id}">Excluir</a></th>
						<th><a href="/clientes/editar/${cliente.id}">Editar</a></th>
					</tr>
				</c:forEach>
			</table>
		</main>
