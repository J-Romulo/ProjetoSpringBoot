...
<link rel="stylesheet" href="../resources/css/editaCliente.css">
...
<header>
		...
		<main>
		     <section id="form_container">
				 <form:form method="POST" modelAttribute="userForm" action="/users/editar2">
					
					<legend class="mb-3">Editar cliente: </legend>
			        <form:hidden path="id" cssClass="form-control"/>
			        <form:hidden path="perfis" cssClass="form-control"/>
			        ...
			        <form:errors path="senha" cssClass="error"></form:errors><br>
