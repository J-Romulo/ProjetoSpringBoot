...
<link rel="stylesheet" href="../resources/css/novaPostagem.css">
...
<body>
        ...
        <main>
		     <section id="form_container">	
				 <form:form method="POST" modelAttribute="postagemForm" action="/postagens/adicionar" id="form_signup">
				
			        <legend class="mb-3">Criar nova postagem: </legend>
